...
def build_design_agents():
    ...
    # v2.3.7-part5 冷冻: pre-revenue不需要,收入验证后再激活 — 5个设计专家Agent
    active_agents = [
        {
        ...
        # === 冷冻(v2.3.7-part5): pre-revenue不需要,收入验证后再激活 ===
        # visual_designer (视觉设计师) — 与ui_visual_designer职能重叠,pre-revenue阶段不需要
        # {
        ...
        # },
        # interaction_designer (交互设计师) — 无交互式UI,当前只有静态review.html
        # {
        ...
        # },
        # accessibility_specialist (无障碍专家) — 无无障碍需求,yet
        # {
