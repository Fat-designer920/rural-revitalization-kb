...
>
> **当前版本**:v2.3.0-part3.5(feature:新增 F062 E2E 诊断包 Markdown 导出)
...
**part3.5 新增 feature**:
- **E2E 诊断包导出**:端到端测试报告弹窗 footer 新增"导出诊断包"按钮,一键下载 Markdown 格式完整诊断包(含元数据 / 六维分 / 白名单 / **issue 按 rule_id+文件聚合的清单** / 近 7 天事件日志摘要)。**用于发给 Claude 做异地诊断**,再也不用网页一条条切四态
...
│   ├── e2e_diagnosis_exporter.py  # F062 诊断包 Markdown 导出引擎（v2.3.0-part3.5 新建，~574 行，纯读格式化）
