...
系统检查 / 一键备份 / 恢复备份 / 保鲜扫描 / 智能重复检测 / 政策补跑 / 质检补跑 / 审核统计 / API 费用 / **知识库体检（F048）** / **端到端健康测试（F062）**
...
│   ├── db_manager.py        # 数据库管理（21 表，F048 12 方法 + F062 9 方法）
...
│   ├── e2e_tester.py        # F062 端到端测试引擎（~1250 行）
