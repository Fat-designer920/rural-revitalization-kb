...
>
> **当前版本**:**v2.3.7**(集团化重构: 6部门16个AI Agent + CEO V4-Pro深度决策 + 会议辩论共识 + 客户画像驱动 + NPU/GPU智能调度)— 聚焦"策划+融资"垂直锚点,锚定月入20万。**核心交付**: agents/独立目录(16模块) / CEO receive_instruction()唯一入口 / 七步会议协议 / Agent验证器(4项上岗测试) / 后勤保障Agent(内存+NPU+GPU) / 客户画像研究员。历史版本:v2.3.6-part1 并行双模型提取 / v2.3.5-part2 V4-Pro全链路 / v2.3.5-part1 知识关系网络

## 集团架构(v2.3.7)

**乡村振兴知识集团** — 6部门16个AI Agent,锚定"策划+融资",月入20万目标
