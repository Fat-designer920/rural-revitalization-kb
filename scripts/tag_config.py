        ...
        "tags": [
            {
                "code": "A01",
                "name": "全域土地综合整治",
                "definition": "整治试点、管理办法、实施方案、综合整治相关的一切内容",
            },
            {
                "code": "A02",
                "name": "增减挂钩",
                "definition": "城乡建设用地增减挂钩指标的产生、交易、使用",
            },
            {
                "code": "A03",
                "name": "占补平衡",
                "definition": "耕地占补平衡、补充耕地指标",
            },
            {
                "code": "A04",
                "name": "集体建设用地入市",
                "definition": "集体经营性建设用地入市规则、定价、收益分配",
            },
            {
                "code": "A05",
                "name": "川西林盘保护",
                "definition": "川西林盘的认定、修复、保护利用",
            },
            {
                "code": "A06",
                "name": "高标准农田",
                "definition": "高标准农田建设、提质改造、验收",
            },
            {
                "code": "A07",
                "name": "生态修复治理",
                "definition": "矿山修复、水土治理、生态补偿、碳汇",
            },
            {
                "code": "A08",
                "name": "国土空间规划",
                "definition": "用途管制、三区三线、村庄规划",
            },
            {
                "code": "A09",
                "name": "宅基地改革",
                "definition": "宅基地退出、流转、有偿使用",
            },
            {
                "code": "A10",
                "name": "乡村产业运营",
                "definition": "民宿农旅、集体经济、产业导入、运营管理",
            },
            {
                "code": "A11",
                "name": "耕地保护",
                "definition": "永久基本农田、非农化非粮化、耕地保护责任",
            },
            {
                "code": "A12",
                "name": "农村人居环境",
                "definition": "人居环境整治、风貌提升、基础设施",
            },
            {
                "code": "A13",
                "name": "指标交易与定价",
                "definition": "各类指标(增减挂钩/占补/碳汇)的市场化交易规则与价格",
            },
        ],
    },
    "B": {
        ...
        "tags": [
            {
                "code": "B01",
                "name": "前期策划",
                "definition": "选址论证、可行性分析、合作模式选择",
            },
            {
                "code": "B02",
                "name": "立项审批",
                "definition": "项目申报、批复流程、部门协调",
            },
            {
                "code": "B03",
                "name": "规划设计",
                "definition": "方案编制、规划衔接、技术标准",
            },
            {
                "code": "B04",
                "name": "资金筹措",
                "definition": "资金来源、融资方案、资金拼盘设计",
            },
            {
                "code": "B05",
                "name": "招标采购",
                "definition": "招标方式、EPC打捆、评标标准",
            },
            {
                "code": "B06",
                "name": "实施推进",
                "definition": "施工管理、进度协调、问题处置",
            },
            {
                "code": "B07",
                "name": "验收评估",
                "definition": "竣工验收、成效评估、指标核算",
            },
            {
                "code": "B08",
                "name": "运营移交",
                "definition": "后期运营、资产移交、长效管护",
            },
        ],
    },
    "C": {
        ...
        "tags": [
            {
                "code": "C01",
                "name": "政策解读",
                "definition": "对政策条款的提炼和实操解读，用于文章的政策背景和合规依据",
            },
            {
                "code": "C02",
                "name": "实战案例",
                "definition": "有地点、有数据、有过程、有结果的真实项目，用于案例举证和对标",
            },
            {
                "code": "C03",
                "name": "操盘方法",
                "definition": "可复用的策略、流程、方法论，产品的核心干货部分",
            },
            {
                "code": "C04",
                "name": "数据支撑",
                "definition": "可直接引用的数据、基准值、对比数据，增强说服力的硬证据",
            },
            {
                "code": "C05",
                "name": "避坑指南",
                "definition": "失败教训、风险点、常见误区，最吸引眼球的血泪教训",
            },
            {
                "code": "C06",
                "name": "深度洞察",
                "definition": "反常识判断、行业真相、趋势预判，产品的灵魂和差异化卖点",
            },
            {
                "code": "C07",
                "name": "模板范本",
                "definition": "可直接套用的方案结构、合同条款、申报材料",
            },
            {
                "code": "C08",
                "name": "话术表达",
                "definition": "面向不同对象的沟通方式、汇报策略",
            },
            {
                "code": "C09",
                "name": "问答语料",
                "definition": "一问一答粒度的知识颗粒，直接支撑问答助手",
            },
        ],
    },
    "D": {
        ...
        "tags": [
            {
                "code": "D01",
                "name": "决策参考",
                "definition": "面向政府领导/局长，关注该不该做、怎么选择",
            },
            {
                "code": "D02",
                "name": "操盘指导",
                "definition": "面向平台公司/项目经理，关注具体怎么做、步骤是什么",
            },
            {
                "code": "D03",
                "name": "专业深化",
                "definition": "面向咨询师/规划师，关注怎么做得更好、有什么别人不知道的",
            },
            {
                "code": "D04",
                "name": "入门普及",
                "definition": "面向新人/跨行者，关注这是什么、为什么这样",
            },
            {
                "code": "D05",
                "name": "谈判说服",
                "definition": "面向需要对外说服他人的人，需要案例+数据+话术",
            },
        ],
    },
    "E": {
        ...
        "tags": [
            {
                "code": "E01",
                "name": "独家经验",
                "definition": "只有亲身经历过才知道的，网上搜不到",
            },
            {
                "code": "E02",
                "name": "稀缺信息",
                "definition": "虽非独家，但行业内少数人知道、不易获取",
            },
            {
                "code": "E03",
                "name": "公开信息",
                "definition": "网上可以搜到的政策原文、公开数据，做背景铺垫用",
            },
        ],
    },
    "F": {
        ...
        "tags": [
            {
                "code": "F01",
                "name": "时效敏感",
                "definition": "包含可能过时的数据、价格、政策状态，引用时需加时效提醒",
            },
            {
                "code": "F02",
                "name": "长期有效",
                "definition": "方法论、经验、流程等不易过时的内容",
            },
            {
                "code": "F03",
                "name": "待验证",
                "definition": "未经充分实战验证的判断或传闻，引用时需加仅供参考标记",
            },
        ],
    },
}
...
CONTENT_READINESS = {
    "draft": {
        "name": "草稿级",
        "definition": "内容粗糙，仅供内部参考，不适合用于付费产品",
    },
    "quotable": {
        "name": "可引用级",
        "definition": "内容完整准确，可用于知识产品和问答助手",
    },
...
# ============================================================
# 政策查找指引（v2.1.0-d F028新增）
# 当知识点引用的政策不在知识库中时，按政策层级给出查找渠道
# 用户在审核界面看到"这条政策没找到"时，同时看到"去哪里找"
# ============================================================
POLICY_LOOKUP_GUIDE = {
    "国家级": "查找渠道: 自然资源部官网(www.mnr.gov.cn) > 政策法规 > 部门规章/规范性文件; "
    "或 国务院官网(www.gov.cn) > 政策 > 最新文件",
    "省级": "查找渠道: 四川省自然资源厅(dnr.sc.gov.cn) > 政策法规 > 规范性文件; "
    "或 四川省人民政府(www.sc.gov.cn) > 政务公开 > 政策文件",
    "市县级": "查找渠道: 对应市/县自然资源局官网 > 政务公开 > 规范性文件; "
    "或联系当地自然资源局索取原文",
    "行业规范": "查找渠道: 相关行业协会官网; 或 标准网(www.gb688.cn) 查找国家/行业标准",
    "default": "查找渠道: 先在自然资源部官网搜索文号/标题; "
    "未找到则查四川省自然资源厅官网; 仍未找到可联系老唐确认来源",
}
...
def get_layer2_for_prompt(content_type):
    ...
    for dim_code, dim in LAYER2_DIMENSIONS.items():
        if not dim["applies_to"] or content_type in dim["applies_to"]:
            if dim["values"]:
                lines.append(
                    f"  {dim['name']}({dim_code})：从以下选项中选——{'/'.join(dim['values'])}"
                )
            else:
